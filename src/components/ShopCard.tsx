...
const ShopCard = ({ imageUrl, category, name, description, price }: ProductCardProps) => {
  return (
    <motion.div
    ...
    >
      ...
      <div className="p-4 flex flex-col grow"> {/* Updated: flex-grow */}
        <span className="text-sm text-gray-500">{category}</span>
        <h3 className="text-lg font-semibold text-gray-900 mt-1 truncate">{name}</h3>
        
        {/* ADDED DESCRIPTION */}
        <p className="text-sm text-gray-600 mt-2 grow"> {/* Updated: flex-grow */}
          {description}
        </p>
        
        <div className="flex justify-between items-center mt-3 pt-3 border-t"> {/* Added border-t */}
